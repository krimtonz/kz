...
#define IO_FLASH_CMD_NOP    0x00
#define IO_FLASH_CMD_BLOCK2 0x4B

#define ioCmdWrite(x)        z2_setFlashStatus(x,(FLASH_ADDR | 0x00010000),(IO_FLASH_CMD_WRITE << 24))
#define ioCmdRead(x)         z2_setFlashStatus(x,(FLASH_ADDR | 0x00010000),(IO_FLASH_CMD_READ << 24))
#define ioCmdSetBlock(x,y)   z2_setFlashStatus(x,(FLASH_ADDR | 0x00010000),((IO_FLASH_CMD_BLOCK << 24) | y))
#define ioCmdExe(x)          z2_setFlashStatus(x,(FLASH_ADDR | 0x00010000),(IO_FLASH_CMD_EXE << 24))
#define ioCmdNop(x)          z2_setFlashStatus(x,(FLASH_ADDR),(IO_FLASH_CMD_NOP << 24))
#define ioCmdSetBlock2(x,y)  z2_setFlashStatus(x,(FLASH_ADDR | 0x00010000),((IO_FLASH_CMD_BLOCK2 << 24) | y))
