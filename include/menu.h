...
#define MENU_EVENT_NUMBER   (0b1 << 7)
#define MENU_EVENT_KEYBOARD (0b1 << 6)
#define MENU_EVENT_LIST     (0b1 << 5)
#define MENU_EVENT_NAVIGATE (0b1 << 4)
#define MENU_EVENT_UPDATE   (0b1 << 3)
#define MENU_EVENT_RETURN   (0b1 << 2)
